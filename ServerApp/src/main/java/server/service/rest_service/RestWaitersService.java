...
class RestWaitersService extends RestBarmenService implements IWaitersService {
   ...
   private transferFiles.service.rmiService.IWaitersService waitersService;
    ...
    public Product removeProductById(@RequestParam int id) throws ProductByIdNotFoundException {
    ...
    public Ingridient addIngridient(AddIngridientRequest request) {
