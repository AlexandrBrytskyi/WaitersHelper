...
//
//    private static ApplicationContext context = new ClassPathXmlApplicationContext("server-app-context.xml");
//
//
//    @BeforeClass
...
////
//    @Test
//    public void addUserTest() throws WrongPasswordException {
//        User user = new User();
//        user.setName("Vasia2");
//        user.setLogin("vasia");
//        user.setPass(new Password("12345").hashCode());
