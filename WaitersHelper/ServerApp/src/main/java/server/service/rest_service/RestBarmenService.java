...
public class RestBarmenService implements transferFiles.service.restService.IBarmenService {
    ...
    public Ordering addOrder(@RequestBody Ordering ordering) {
        Ordering added = barmenService.addOrder(ordering);
    ...
    public Denomination addDenomination(@RequestBody AddCancelDenominationRequest request) throws UserAccessException, NoOrderingWithIdException {
        System.out.println(request.getDenomination());
    ...
    public Dish removeDish(@RequestBody RemoveDishRequest request) throws UserAccessException {
        try {
            ...
            if (e.getClass().equals(DataIntegrityViolationException.class))
                throw new UserAccessException("Cant remove as it is already in some ordering");
        }
        return null;
    }
    ...
    public Ordering removeOrdering(@RequestBody RemoveOrderingRequest request) throws UserAccessException {
    ...
    public void generatePrintPdf(@RequestBody Ordering ordering) throws IOException, PrintingException {
        try {
    ...
    public User changePassword(@RequestBody ChangeNamePassRequest request) throws WrongPasswordException {
