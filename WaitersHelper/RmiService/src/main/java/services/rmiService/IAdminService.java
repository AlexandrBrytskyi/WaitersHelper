...
public interface IAdminService extends IWaitersService {
    ...
    List<Denomination> getRequireDenominationsForReport(LocalDate concreteDate) throws DateException;

    List<Denomination> getRequireDenominationsForReport(LocalDate periodStart, LocalDate periodEnd) throws DateException;
