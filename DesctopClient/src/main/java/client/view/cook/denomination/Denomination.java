...
public class Denomination {
    ...
    private server.model.denomination.Denomination denomination;
    private ICookService service;
    private Timer timer;
    private User logined;

    public Denomination(server.model.denomination.Denomination denomination, ICookService service, User logined) {
